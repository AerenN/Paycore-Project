...
import com.creditcalculator.models.Role;
import com.creditcalculator.models.User;
import com.creditcalculator.payload.request.LoginRequest;
import com.creditcalculator.payload.request.SignupRequest;
import com.creditcalculator.payload.response.MessageResponse;
import com.creditcalculator.payload.response.UserInfoResponse;
import com.creditcalculator.repository.RoleRepository;
import com.creditcalculator.repository.UserRepository;
import com.creditcalculator.security.JwtUtils;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        return ResponseEntity.ok().header(HttpHeaders.SET_COOKIE, jwtCookie.toString())
                .body(new UserInfoResponse(userDetails.getId(),
                        ...
                        userDetails.getFirstNameLastName(),
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        User user = new User(signUpRequest.getFirstNameLastName(),
                signUpRequest.getUsername(),
                signUpRequest.getPhoneNumber(),
                signUpRequest.getIncome(),
